...
|Result Code| Result Code(Hex) |설명|
|---|---|---|
|0|	0x00000000 | 요청 성공.|
|1|	0x00000001 | 요청은 성공 했지만, 기존과 동일한 데이터가 들어와서 업데이트 하지 않음.|
|459777| 0x00070401 | 앱키 인증 실패. |
|462849| 0x00071001 | 초기화 실패. |
|462850| 0x00071002 | 등록되지 않은 사용자. |
|462851| 0x00071003 | 등록되지 않은 팩터.|
|462852| 0x00071004 | 등록되지 않은 앱키. |
|462853| 0x00071005 | Extra Data 제한 길이 초과. |
|462854| 0x00071006 | 잘못된 범위. |
|462855| 0x00071007 | 잘못된 파라메터. |
|463000| 0x00071098 | 시스템 에러.|
|463001| 0x00071099 | 미확인 에러.|
